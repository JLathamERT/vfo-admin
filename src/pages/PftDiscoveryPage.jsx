...
export default function PftDiscoveryPage() {
  ...
  if (state === 'loading') {
    return <div style={{ ...pageStyle, alignItems: 'center' }}><div style={{ textAlign: 'center', maxWidth: '480px', padding: '48px 32px', color: 'var(--vfo-muted)', fontSize: '15px' }}>Loading…</div></div>
  }
