    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            padding: '12px 16px', borderBottom: '1px solid var(--vfo-tint-deep)',
            display: 'flex', justifyContent: 'space-between', alignItems: 'center'
          }}>
            <span style={{ fontSize: '13px', fontWeight: '600', color: 'var(--vfo-ink)' }}>Notifications</span>
            {count > 0 && (
            ...
            notifications.map(n => {
              ...
              return (
                <div
                  ...
                  style={{
                    padding: '12px 16px', borderBottom: '1px solid var(--vfo-tint)',
                ...
                >
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: '13px', color: 'var(--vfo-ink)', fontWeight: '500', marginBottom: '2px' }}>{n.title}</div>
                    <div style={{ fontSize: '12px', color: 'var(--vfo-muted)', marginBottom: '4px' }}>{n.message}</div>
