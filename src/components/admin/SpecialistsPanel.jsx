...
const CIQ_TOPICS = ["Asset Protection","Business Exit / Succession Planning","Business Valuation","Buy-Sell Agreements","Captive Insurance","Charitable Planning","Cost Segregation","Deferred Sales Trust","Delaware Statutory Trust (DST)","Dynasty Trusts","ERISA / Retirement Plan Consulting","Estate Planning","Executive Benefits","Family Limited Partnership (FLP)","Final Expense / Burial Insurance","Fixed Indexed Annuities","Group Benefits","HSA / HRA Planning","Indexed Universal Life (IUL)","Key Person Insurance","Life Insurance Advanced Planning","Long-Term Care Insurance","Medicare Planning","Opportunity Zone Investing","Premium Finance Life Insurance","Private Placement Life Insurance (PPLI)","Qualified Opportunity Zone Funds","R&D Tax Credits","Real Estate Tax Planning","Section 1031 Exchange","Self-Directed IRA / Solo 401k","Social Security Optimization","Split Dollar Plans","Tax-Efficient Investing","Voluntary Benefits","Wealth Transfer Strategies","Workers Compensation"]