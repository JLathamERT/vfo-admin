  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto' }}>
      <PanelHero
        ...
        title="Accountant Onboarding Pipeline"
        action={
          <SandboxModeToggle
      ...
      {rows.length === 0 ? (
        <EmptyState title="No accountant onboarding records yet" hint="Accountants appear here as they enter the onboarding flow" />
      ) : (
        rows.map(r => (
