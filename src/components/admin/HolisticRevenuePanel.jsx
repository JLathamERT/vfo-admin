...
function TierTag({ tier }) {
  const t = tier || ''
  const c = t === 'Max' ? { bg: 'rgba(180,131,9,0.14)', fg: '#b48309' } : t === 'Core' ? { bg: 'rgba(18,94,204,0.10)', fg: '#125ecc' } : t === 'Lite' ? { bg: 'rgba(78,96,135,0.12)', fg: '#4e6087' } : { bg: '#eef2f9', fg: '#9aa7be' }
  ...
  return (
    <div style={wrap}>
      <div style={{ marginBottom: '18px' }}>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 800, color: NAVY, margin: 0 }}>Holistic Planning Revenue</h2>
      </div>
