  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1050px', margin: '0 auto', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ marginBottom: '18px' }}>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 800, color: NAVY, margin: 0 }}>{title}</h2>
      </div>
      <div style={{ textAlign: 'center', padding: '60px 24px', color: '#9aa7be', fontSize: '14px', border: '1px dashed #d6e0f0', borderRadius: '14px', background: '#fbfdff' }}>
