...
export const TEMPLATE_META = {
  ...
  'TAX': [
    ...
    ['TAX_tax3_assess_reminder_early', 'Assess form still missing 5 business days before the booked ROI meeting — the EARLIER of the two reminders drafted by the nightly sweep', 'To: Allocated Tax Planner · Auto-Cc: group Team Members + PF'],
    ['TAX_tax3_assess_reminder_early|vault', 'Vault variant of the 5-business-day early reminder — asks the planner to upload the Tax Assessment PDF into the Sensitive Documents vault section', 'To: Allocated Tax Planner · Auto-Cc: group Team Members + PF'],
    ['TAX_tax3_assess_reminder', 'Assess form still missing 2 business days before the booked ROI meeting — the LATER, last-call reminder drafted by the nightly sweep', 'To: Allocated Tax Planner · Auto-Cc: group Team Members + PF'],
