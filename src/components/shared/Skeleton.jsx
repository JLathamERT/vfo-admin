...
export function SkeletonCard({ rows = 3, title = true }) {
  return (
    <div style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '24px', marginBottom: '16px' }}>
  ...
  return (
    <div>
      {Array.from({ length: sections }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '24px', marginBottom: '20px' }}>
  ...
  return (
    <div>
      ...
      {Array.from({ length: phaseCount }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '18px 24px', marginBottom: '12px' }}>
...
export function PFTTrackSkeleton() {
  ...
  return (
    <div>
      {phases.map((rows, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', marginBottom: '10px', overflow: 'hidden' }}>
  ...
  return (
    <div>
      ...
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '20px 24px', marginBottom: '12px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
...
export function AdvisorOnboardingDetailSkeleton({ onBack }) {
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '18px 24px', marginBottom: '14px' }}>
      ...
      {Array.from({ length: yearCount }).map((_, y) => (
        <div key={y} style={{ marginBottom: '16px' }}>
          ...
          {Array.from({ length: meetingsPerYear }).map((_, i) => (
            <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '12px', boxShadow: '0 2px 10px rgba(20,45,95,0.05)', padding: '14px 18px', marginBottom: '8px', marginLeft: '18px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
  ...
  return (
    <div>
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '18px', marginBottom: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
...
export function AdminProgramViewSkeleton() {
  return (
    <div>
      ...
      <div style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '24px', marginBottom: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '24px', borderBottom: '1px solid var(--vfo-border)', paddingBottom: '10px' }}>
  ...
  return (
    <div>
      ...
      {Array.from({ length: clientCards }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '20px 24px', marginBottom: '16px' }}>
...
export function TrainingTrackSkeleton({ phaseCount = 2, rowsPerPhase = 5 }) {
  return (
    <div>
      ...
      {Array.from({ length: phaseCount }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '24px', marginBottom: '16px' }}>
  ...
  return (
    <div>
      {Array.from({ length: phases }).map((_, i) => (
        <div key={i} style={{ background: 'var(--vfo-card)', border: '1px solid var(--vfo-border-soft)', borderRadius: '16px', boxShadow: 'var(--vfo-shadow-card)', padding: '20px 24px', marginBottom: '12px' }}>
