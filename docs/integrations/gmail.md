...
**The auto-send roster: exactly NINE templates, and everything else in the 195-row table is Draft (2026-08-03, gotcha #325).** Until this date the toggle was effectively unused, so "sending an email" meant "creating a Gmail draft a human then reviews and sends". That is no longer universally true. **These nine — and only these nine — leave without anyone looking at them:**
