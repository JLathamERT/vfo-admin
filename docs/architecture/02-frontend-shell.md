...
| `/specialist-pay` | [SpecialistPayPage](src/pages/SpecialistPayPage.jsx) | URL token + `type` | Stage 3 background-check payment (ACH/Card picker, `type=core\|max`, $350/$950) → `automation_SPECIALIST_bgloadpayment` + `automation_SPECIALIST_bgcheckout`. Added 2026-06-03. |
