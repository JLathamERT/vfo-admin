...
| `/specialist-revenue-pay` | [SpecialistRevenuePayPage](src/pages/SpecialistRevenuePayPage.jsx) | URL token | PUBLIC page from the VFO Specialist Revenue "payment request" email — the specialist pays the gross (card grossed up / ACH par). `specialist_revenue_pay_load` + `specialist_revenue_checkout` (`metadata.pipeline=VFO_SPECIALIST_REVENUE`). MAP 1 pay-page layout. Added 2026-06-29. |
