...
| `isTaxAdmin(email)` | `constants/tax-access.ts` | Allowlist (Jake `jlatham@`, Tray `tvaldes@`, Paul `platham@` elitert.com — Tim `tgacsy@` removed 2026-07-21 after leaving) gating who may view/download/share client tax returns. |
