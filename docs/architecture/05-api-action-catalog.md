...
All **223 actions** dispatched by `vfo-admin-api` (3 logins + 71 PUBLIC + 149 AUTH). Composition: MAP1 baseline of 134 + ~28 tax handlers in `actions/tax/` (see [../flows/tax-planning.md](../flows/tax-planning.md)) + 21 Advisor Onboarding handlers in `actions/advisor/` (Phases 1-6 deployed 2026-05-22 through 2026-05-26 + member-portal login setup chain + admin Automation Panel loader added 2026-05-28; see `ADVISOR_ONBOARDING_RESUMPTION.md` at repo root) + 14 PIP Meetings handlers (deployed 2026-05-27; see [../flows/pip-meetings.md](../flows/pip-meetings.md)) + 22 Accountant Onboarding handlers in `actions/accountant/` (cloned from advisor with `save-partnership` added for the new Stage 1 Partnership? step; deployed 2026-05-28 as v323→v330; see `ACCOUNTANT_ONBOARDING_RESUMPTION.md` at repo root) + 5 Specialist Onboarding handlers in `actions/onboarding/` (Stages 1–2 automation: `automation_SPECIALIST_prelimemail`, `automation_SPECIALIST_stage2email` [AUTH]; `automation_SPECIALIST_loadsif`, `automation_SPECIALIST_submitsif`, `automation_SPECIALIST_revsharedecide` [PUBLIC]; deployed 2026-06-02 as v360; see [../flows/specialist-onboarding.md](../flows/specialist-onboarding.md)). The post-refactor catalog cites file paths (not line numbers — line numbers shift across handler edits). Action names and behavior are byte-equivalent to v194 except for explicit follow-up changes noted in entries below.
