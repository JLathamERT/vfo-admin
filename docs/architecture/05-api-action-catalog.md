...
All **196 actions** dispatched by `vfo-admin-api` (3 logins + 54 PUBLIC + 139 AUTH). Composition: MAP1 baseline of 134 + ~28 tax handlers in `actions/tax/` (see [../flows/tax-planning.md](../flows/tax-planning.md)) + 21 Advisor Onboarding handlers in `actions/advisor/` (Phases 1-6 deployed 2026-05-22 through 2026-05-26 + member-portal login setup chain + admin Automation Panel loader added 2026-05-28; see `ADVISOR_ONBOARDING_RESUMPTION.md` at repo root) + 14 PIP Meetings handlers (deployed 2026-05-27; see [../flows/pip-meetings.md](../flows/pip-meetings.md)). The post-refactor catalog cites file paths (not line numbers — line numbers shift across handler edits). Action names and behavior are byte-equivalent to v194 except for explicit follow-up changes noted in entries below.
