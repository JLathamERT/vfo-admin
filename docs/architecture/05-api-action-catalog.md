...
| `automation_SPECIALIST_ddcapprove` *(AUTH, admin)* | `actions/onboarding/ddc-approve.ts` | `specialist_onboarding`, `email_templates` | `specialist_onboarding` (`ddc_review_status='approved'`, `ddc_review_log`) | Gmail `SPECIALIST_ddc_approved` (TBD body) |
