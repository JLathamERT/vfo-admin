...
> **Open question (carried from [stripe.md](../integrations/stripe.md)):** how subsequent payments 2-4 get created with `metadata.payment_number` set. No code path in this repo creates them.
